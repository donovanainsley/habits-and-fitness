...
1. Log in to GitHub and locate the [GitHub Repository](https://github.com/donovanainsley/habits-and-fitness)
...
7. At the top of the repositry there will be a box with a [Visit Site](https://donovanainsley.github.io/habits-and-fitness/) button, to view the published website.
...
- Habits and Fitness logo was created by the developer using [Logo.com](https://www.logo.com)
- All images used within the website were free for use and downloaded from [freepik](https://www.freepik.com/).

### Acknowledgements

- [Iris Smok](https://github.com/Iris-Smok) - Cohort Facilitator: with her weekly stand-ups where she continously pushes and encourages us to succeed but also ensuring we're happy with our own progress and taking the time out to check on us individually.
